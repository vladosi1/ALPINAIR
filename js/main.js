...
// 	// Относительный путь к файлу заднего фона
// 	var imagePath = './img/header-bg.png';
...
// 	// Добавляем линейный градиент поверх изображения
// 	var gradientDiv = document.createElement('div');
// 	gradientDiv.classList.add('gradient-overlay');
// 	headerContainer.appendChild(gradientDiv);
//  });

//  document.addEventListener('DOMContentLoaded', function () {
// 	// Относительный путь к файлу заднего фона
// 	var imagePathToPathSection = './img/path__bg.jpg';
 
// 	// Получаем контейнер
// 	var headerContainer2 = document.querySelector('.path');
 
// 	// Устанавливаем фоновое изображение
// 	headerContainer2.style.backgroundImage = 'url("' + imagePathToPathSection + '")';
 
// 	// Добавляем линейный градиент поверх изображения
// 	var gradientDiv = document.createElement('div');
// 	gradientDiv.classList.add('gradient-overlay');
// 	headerContainer2.appendChild(gradientDiv);
//  });
  ...
  function animateNumber(element, duration, endValue) {
    let start = 0;
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var element1 = document.getElementById('animated_number1');
    var element2 = document.getElementById('animated_number2');
    var jalousieSection = document.querySelector('.jalousie');

    function checkVisibility() {
      if (isElementInViewport(jalousieSection)) {
        if (element1) {
          animateNumber(element1, 1500, 14); // для animated_number1
        }
        if (element2) {
          animateNumber(element2, 2000, 1372); // для animated_number2
        }
